...
from app.grpc.bootstrap import bind_event_loop  # must run before v1 stub imports
from v1 import auth_pb2_grpc, category_pb2_grpc, health_pb2_grpc, inventory_pb2_grpc
from app.grpc.servicers.auth import AuthServicer
from app.grpc.servicers.category import CategoryServicer
...
def register_servicers(server: grpc.aio.Server) -> None:
    ...
    category_pb2_grpc.add_CategoryServiceServicer_to_server(CategoryServicer(), server)
